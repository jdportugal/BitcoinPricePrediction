...
def build_timeseries(mat, y_col_index):
	...
	for i in range(dim_0-1):
		...
		#print(mat[TIME_STEPS+i+1,y_col_index]-mat[TIME_STEPS+i,y_col_index],y_col_index)
		if((mat[TIME_STEPS+i+1,y_col_index]-mat[TIME_STEPS+i,y_col_index])>0):
			y[i] = 1
		else:
			y[i] = 0
		#print(y[i])
...
lstm_model.save('binary.h5') 
lstm_model = load_model('binary.h5') 
...
plt.plot(gotten, color="g", label="gotten")
